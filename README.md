...
# Quick Start:
## 1. Follow the installation steps of the NTU Autonomous Racing GitHub. 
Here are the steps if you wish to open again after your first time installation and change the map.
## 2. Open WSL
## 3. Copy paste below code step-by-step 
in your wsl terminal(Assume you are window user):
...
to open the sim.yaml, you should see A GNU text nano editor.
```
...
source install/local_setup.bash
```
## 6. Finally after copy & paste the following code, 
your map has been changed and you're ready to race!
```
ros2 launch f1tenth_gym_ros gym_bridge_launch.py
```
